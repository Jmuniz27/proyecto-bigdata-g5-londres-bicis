...
DuckDB es entre 7 y 20 veces más rápido que Pandas y entre 30 y 40 veces más rápido que SQLite sobre el mismo CSV. El orden se mantiene en las tres máquinas y en todas las versiones.

\subsection{Tiempo total por herramienta y versión}

Suma de las tres preguntas, en segundos. Cada celda es carga $+$ query acumulado.
