...
La demanda sigue un patrón bimodal en días laborables y unimodal en fin de semana. La forma de las dos curvas es distinta, y esa diferencia es la respuesta.
...
El desbalance sigue el patrón radial clásico. Los nodos de transporte y la periferia residencial quedan en déficit, mientras el núcleo financiero y comercial acumula superávit. Con neto $=$ llegadas $-$ salidas, un valor negativo significa que la estación se vacía y hay que abastecerla, y uno positivo que se satura y hay que retirar bicicletas.
...
\textbf{Estaciones sin coordenadas.} Las 7 estaciones fuera del catálogo (Sección \ref{sec:dataset}) no tienen latitud ni longitud, así que quedan fuera de la Figura \ref{fig:q2-mapa}. Su neto (entre $-19$ y $934$) tampoco entra en los 15 extremos de cada lado que muestra la Figura \ref{fig:q2-desequilibrio}, así que ninguna de las dos figuras las representa; solo quedan en la tabla completa que produce el harness.

\begin{figure}[htbp]
  \centering
  \begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figuras/q2_desequilibrio_xl.png}
  ...
  \begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figuras/q2_mapa_xl.png}
...
Hay concentración, aunque la distribución no sigue una ley de Pareto 80/20 y tiene una cabeza mucho más delgada. Sobre 652,864 pares origen-destino teóricamente posibles (808 estaciones al cuadrado), solo 510,672 aparecen alguna vez. Las \textbf{1,000 rutas más transitadas concentran el 9.6\% de todos los viajes}, y las 20 primeras apenas el 1.35\%.
