...
\begin{itemize}
  ...
  \item El catálogo tiene 802 estaciones, pero Q2 y Q3 (Sección \ref{sec:respuestas}) reportan 808 identificadores de estación distintos. Esa cifra sale directo de los \texttt{station\_id} que aparecen como origen o destino en los viajes, no del catálogo: hay estaciones en el historial que no están en \texttt{london\_stations.csv}, probablemente dadas de baja, agregadas después, o puntos temporales como el Aquatic Centre del Olympic Park que aparece en Q3. No afecta ningún cálculo, porque Q2 y Q3 nunca cruzan contra el catálogo.
\end{itemize}
